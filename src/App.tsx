...
function FloatingWhatsApp() {
  return (
    <div className="wsp-wrapper">
      <a href={WA_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackContact('floating')} aria-label="Pedir por WhatsApp" className="wsp-perritos">
        <img src="/perritos.png" alt="Perritos NatuCan" style={{ height: 80, objectFit: 'contain', display: 'block' }} />
      </a>
      <a href={WA_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackContact('floating')} className="wsp-float" aria-label="Pedir por WhatsApp">
