...
const PLANS = [
  {
    ...
    price: '$39.900',
    desc: 'El más popular 🐾',
    features: ['3 bolsas × 100g', 'Ahorras $4.800 vs precio individual', '🚚 Envío GRATIS a Medellín y área metropolitana'],
    featured: true,
    badge: '🚚 Envío GRATIS',
    cta: 'Pedir Combo x3',
  },
  {
    ...
    features: ['2 bolsas × 100g', 'Ahorras $1.900 vs precio individual', '🚚 Domicilio $5.000 a Medellín y área metropolitana'],
    featured: false,
  ...
  },
  {
    ...
    features: ['100g de patas deshidratadas', 'Snack premium para tu perro', '😢 Domicilio $10.000 a Medellín y área metropolitana'],
    featured: false,
